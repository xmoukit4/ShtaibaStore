			  ...
			  <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
				...
				<tr>
					  ...
					  <tr>
						<td class="content-cell">
						  <div class="f-fallback">
							...
							<p>TMerci d\'avoir acheté avec Shtaiba Store. Il s\'agit d\'une facture pour votre achat récent.</p>
				  ...
				  <strong>Amount Due:</strong> '.$user_order['total_price'].'.
							...
							<p>Si vous avez des questions concernant cette facture, il vous suffit de répondre à cet e-mail ou de contacter notre équipe de support pour aide.
