          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://shtaibastore.com" class="f-fallback email-masthead_name">
                Shtaiba Store
              </a>
              </td>
            </tr>
            ...
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Bonjour {{name}},</h1>
                        <p>Merci d\'avoir acheté avec Shtaiba Store. Il s\'agit d\'une facture pour votre achat récent.</p>
              ...
              <strong>Montant dû:</strong> {{total}}
            </span>
                                  </td>
                                </tr>
                              </table>
                        ...
                        <p>Si vous avez des questions concernant cette facture, il vous suffit de répondre à cet e-mail ou de contacter notre <a href="{{support_url}}">équipe de support</a> pour aide.</p>
                        <p>Cordialement,
                          <br>Shtaiba Store</p>
                        <!-- Sub copy -->
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">&copy; 2022 Shtaiba Store. All rights reserved.</p>
                      <p class="f-fallback sub align-center">
                        Shtaiba Store
                        <br>Boulvard Hassan 2,
                        <br>Settat
                      </p>
                    </td>
                  </tr>
