...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Produit</strong><small> Form</small></div>
							   ...
							   <div class="form-group">
									<div class="row">
									  <div class="col-lg-6">
									   ...
									   <div class="col-lg-6">
										<label for="categories" class=" form-control-label">Sous Categories</label>
										<select class="form-control" name="sub_categories_id" id="sub_categories_id">
											<option>Selectionner Sous Category</option>
										</select>
									  </div>
									</div>
								</div>	
								<div class="form-group">
									<div class='row'>
										<div class="col-lg-9">
											<label for="categories" class=" form-control-label">Nom Produit</label>
											<input type="text" name="name" placeholder="Entrer Nom Produit" class="form-control" required value="<?php echo $name?>">
										</div>
										<div class="col-lg-3">
								...
								<div class="form-group"  id="product_attr_box">
									...
									<div class="row"id="attr_<?php echo $attrProductLoop?>">
									  ...
									  <div class="col-lg-2">
										<label for="categories" class=" form-control-label">Coleur</label>
										<select class="form-control" name="color_id[]" id="color_id">
										<option>Color</option>
										<?php
											$res=mysqli_query($con,"select id,color from color order by color asc");
											while($row=mysqli_fetch_assoc($res)){
									  ...
									  <div class="col-lg-2">
										...
										if($attrProductLoop==1){
											...
											<button id="" type="button" class="btn btn-lg btn-danger btn-block" onclick="remove_attr('<?php echo $attrProductLoop?>','<?php echo $list['id']?>')">
												<span id="payment-button-amount">Supprimer</span>
											</button>
											<?php
										}
...
foreach($multipleImageArr as $list){
	...
	echo '<input type="hidden" name="product_images_id[]" value="'.$list['id'].'"/></div>';
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">1er Description</label>
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">2eme Description</label>
