                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-name">nom de products</th>
                                    ...
                                    <tbody>
										...
										?>
											<tr>
												...
												<td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart('<?php echo $row['pid']?>','add')">Ajouter au panier</a></td>
											</tr>
											<?php } ?>
                                    </tbody>
                                </table>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        <div class="buttons-cart">
                                            <a href="<?php echo SITE_PATH?>">Continue </a>
                                        </div>
