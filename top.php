...
$meta_title="Shtaiba Store";
$meta_desc="Shtaiba store pour vendre les vetements";
$meta_keyword="";
$meta_url=SITE_PATH;
$meta_image="";
...
<body>
	...
	<div class="first_navbar">
        <h4>15% de réduction sur votre première commande</h4>
    </div>
    <div class="wrapper">
												...
												<ul class="navbar-nav mr-auto">
												  <li class="nav-item dropdown">
													...
													<div class="dropdown-menu" aria-labelledby="navbarDropdown">
													  <a class="dropdown-item" href="my_order.php">Commandes</a>
