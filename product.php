...
?>
	...
	$resAttr = mysqli_query($con, "select product_attributes.*,color.color,size.size from product_attributes 
			...
			<div class="row">
				...
				<div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
						...
						<div class="ht__pro__desc">
							...
							?>
								...
								<div class="sin__desc">
									...
									?>
									<p><span>Disponible:</span> <?php echo $stock ?></p>
								</div>
							<?php } ?>
					...
					<div id="is_cart_box_show" class="<?php echo $is_cart_box_show ?>">
						...
						<a class="fr__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id'] ?>','add')">Ajouter au panier</a>

						<a class="fr__btn buy_now" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id'] ?>','add','yes')">Achetez Maintenant</a>
					...
					<div role="tabpanel" id="review" class="pro__single__content tab-pane fade active show">
						<div class="pro__tab__content__inner">
							...
							<?php }
								...
								echo "<h3 class='submit_review_hint'>Pas de review</h3><br/>";
							}
							?>


							<h3 class="review_heading">Entrer votre review</h3><br />
							<?php
									...
									<div class="col-md-12">
										<form action="" method="post">
											<select class="form-control" name="rating" required>
												...
												<option>Tres Mauvais</option>
												<option>Mauvais</option>
												<option>Bien</option>
												<option>Tres Bien</option>
												<option>Extraordinaire</option>
											</select> <br />
											<textarea class="form-control" cols="50" id="new-review" name="review" placeholder="Entrer votre review ici..." rows="5"></textarea>
											<div class="text-right mt10">
												<button class="btn btn-success btn-lg" type="submit" name="review_submit">Envoyez</button>
											</div>
										</form>
									</div>
								</div>
							<?php } else {
								echo "<span class='submit_review_hint'>Veuillez <a href='login.php'>s'ithentifier</a> pour envoyer votre review</span>";
							}
							?>
						</div>
					</div>
...
?>
	<section class="htc__produc__decription bg__white">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<h3 style="font-size: 20px;font-weight: bold;">Vu récemment</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
