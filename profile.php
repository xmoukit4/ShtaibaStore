...
<!-- Start Bradcaump area -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6">Changer Password</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									<div class="single-contact-form">
										<label class="password_label">Password courant</label>
										<div class="contact-box name">
									...
									<div class="single-contact-form">
										<label class="password_label">Nouveau Password</label>
										<div class="contact-box name">
									...
									<div class="single-contact-form">
										<label class="password_label">Confirmer Nouveau Password</label>
										<div class="contact-box name">
		...
		function update_password(){
			...
			var is_error='';
			if(current_password==''){
				jQuery('#current_password_error').html('Veuillez entrer mot de passe');
				is_error='yes';
			}if(new_password==''){
				jQuery('#new_password_error').html('Please enter password');
				is_error='yes';
			}if(confirm_new_password==''){
				jQuery('#confirm_new_password_error').html('Veuillez entrer mot de passe');
				is_error='yes';
			}
			
			if(new_password!='' && confirm_new_password!='' && new_password!=confirm_new_password){
				jQuery('#confirm_new_password_error').html('Vuillez entrer le mot de passe');
				is_error='yes';
			}
			
			if(is_error==''){
				jQuery('#btn_update_password').html('...');
